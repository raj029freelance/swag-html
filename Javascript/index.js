  ...
  fetch("https://my-json-server.typicode.com/adithkrishnan98/swagofindia/db")
    ...
    .then((json) => {
      ...
      productsList.products.forEach((product) => {
        ...
        htmlToReturn2 = `<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-12">
...
xmlhttp.onreadystatechange = function () {
  if (this.readyState == 4 && this.status == 200) {
    ...
    document.getElementById("originalPrice").innerHTML =
      calculateOriginalCartValue(pricesOriginal);
    document.getElementById("bagDiscount").innerHTML =
      document.getElementById("originalPrice").innerHTML -
      document.getElementById("totalCartValue").innerHTML;
    ...
    for (let i = 0; i < totalCartItems; i++) {
      document.getElementById("exampleFormControlSelectQuantity" + i).onchange =
        () => {
          ...
          const selected_quantity = document.getElementById(
            "exampleFormControlSelectQuantity" + i
          ).selectedIndex;
          document.getElementById("final-price" + i).innerHTML =
            pricesOnDiscount[i] * selected_quantity;
          document.getElementById("initial-price" + i).innerHTML =
            pricesOriginal[i] * selected_quantity;
          pricesOnDiscount2[i] = pricesOnDiscount[i] * selected_quantity;
          pricesOriginal2[i] = pricesOriginal[i] * selected_quantity;
          document.getElementById("totalCartValue").innerHTML =
            calculateTotalCartValue(pricesOnDiscount2);
          document.getElementById("originalPrice").innerHTML =
            calculateOriginalCartValue(pricesOriginal2);
          document.getElementById("bagDiscount").innerHTML =
            document.getElementById("originalPrice").innerHTML -
            document.getElementById("totalCartValue").innerHTML;
          document.getElementById("orderTotal").innerHTML =
          ...
          localStorage.setItem(
            "originalPrice",
            calculateTotalCartValue(pricesOriginal2)
          );
        };
      ...
      function fadeOutEffect() {
        ...
        var fadeEffect = setInterval(function () {
          ...
          if (fadeTarget.style.opacity > 0) {
            ...
            document.getElementById("totalCartValue").innerHTML =
              calculateTotalCartValue(pricesOnDiscount2) - pricesOnDiscount2[i];
            document.getElementById("originalPrice").innerHTML =
              calculateOriginalCartValue(pricesOriginal2) - pricesOriginal2[i];
            document.getElementById("bagDiscount").innerHTML =
              document.getElementById("originalPrice").innerHTML -
              document.getElementById("totalCartValue").innerHTML;
            document.getElementById("orderTotal").innerHTML =
...
xmlhttp2.onreadystatechange = function () {
  if (this.readyState == 4 && this.status == 200) {
    ...
    for (let i = 0; i < totalWishlistItems; i++) {
      document
        .getElementById("removeFromWishlist" + i)
        .addEventListener("click", fadeOutEffect2);
      function fadeOutEffect2() {
        var productId2 = document
          .getElementById("removeFromWishlist" + i)
        ...
        var fadeEffect = setInterval(function () {
          ...
          counter2 = JSON.parse(localStorage.getItem("Wishlist_IDs")).length;
          document.querySelector("#wishlist-badge").innerHTML =
            String(counter2);
        }, 100);
      }
...
btn_save.onclick = () => {
  console.log("click!");
  setLocalStorage(), goToProfilePage();
};
...
window.onload = function () {
  if (localStorage.getItem("Mobile Number") == null) {
    ...
    document.getElementById("profileInputMobileNum").value =
  ...
  if (localStorage.getItem("Full Name") == null) {
    ...
    document.getElementById("profileInputFullname").value =
      localStorage.getItem("Full Name");
  }
  if (localStorage.getItem("Email") == null) {
    document.getElementById("profileInputEmail1").value =
      "markmathhews@xyz.com";
  } else {
    document.getElementById("profileInputEmail1").value =
